...
all_questions = [
    ...
    Question(label="template",
             ...
             default="static",
             parent=None,
             choices=["static", "python", "php", "react", "node"],
             ),
    ...
    Question(label="system_dependencies",
             desc="System dependencies",
             info="Package names that should be installed (separated by ` `, empty if none, ex: git vim)",
             default="",
             parent=[("template", "python"),
                     ("template", "php"),
                     ("template", "node"),
    ...
    Question(label="custom_install_script",
             desc="Custom Install Script",
             info="Use a custom install script",
             boolean=True,
             default=False,
             parent=[("template", "python"),
                     ("template", "php"),
    ...
    Question(label="dependencies_files",
             ...
             default="",
             parent=[("custom_install_script", False),
                     ],
             ),
    Question(label="install_script_dependencies",
             desc="Install Script Dependencies",
             info="Files to install dependencies (separated by `:`, empty if none, ex: package.json:file.txt)",
             default="",
             parent=[("custom_install_script", True),
                     ],
             ),
    Question(label="install_script",
             desc="Install Script",
             info="Script to be run before the source had been cloned (ex: npm -i package.json)",
             default="",
             parent=[("custom_install_script", True),
                     ],
             ),
